...
class GalbotControl:
    ...
    def move_to_init_pose_wholebody(self):
        ...
        if self.args.has_init_action:
            ...
            self.set_wholebody_angle_asynchronous(np.array([2] + self.init_pose + self.galbot_interface.chassis_pos).reshape(-1, 1), 0.03, 0.004)
    ...
    def set_wholebody_command(self, obs, obs_visualization, response):
        ...
        time.sleep(self.args.action_horizon_use * self.args.dt_model_control - 0.05)
        while True:
