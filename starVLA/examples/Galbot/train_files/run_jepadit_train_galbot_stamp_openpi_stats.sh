...
export CONFIG_YAML=${CONFIG_YAML:-./examples/Galbot/train_files/jepadit_train_galbot_stamp_arms_delta.yaml}
...
export RUN_ID=${RUN_ID:-jepadit_galbot_stamp_0503_bs${PER_DEVICE_BATCH_SIZE}_step${MAX_TRAIN_STEPS}_ga2_lr1p5e5_${STATE_TAG}}
