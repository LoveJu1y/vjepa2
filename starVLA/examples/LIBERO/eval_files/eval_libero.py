...
class Args:
    ...
    max_videos_to_save: int = -1  # Save at most N rollout videos; negative means save all
...
def eval_libero(args: Args) -> None:
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for episode_idx in tqdm.tqdm(range(args.num_trials_per_task)):
            ...
            should_save_video = args.max_videos_to_save < 0 or saved_videos < args.max_videos_to_save
        ...
        per_task_success_rate[task_description] = current_task_success_rate
